...
function AddProductPage({setContent}) {
                            ...
                            <tr class= "info_classification" key={`${i}-${j}`}>
                                {j === 0 && (
                                    ...
                                    <div style={{display:"flex", flexDirection:"column", alignItems:"center"}}>
                                        ...
                                        <img src={imageLabel1s[i]} style={{maxWidth:100}}></img>
                                ...
                                <td>
                                <CurrencyInput intlConfig={{ locale: 'vi-VN', currency: 'VND' }}  onValueChange={(value)=>handleInfoTOPChange(value,i,j,"originalPrice")}/>                                                                                    
                                </td>
                                <td>
                                <CurrencyInput
                                    intlConfig={{ locale: 'vi-VN', currency: 'VND' }} onValueChange={(value)=>handleInfoTOPChange(value,i,j,"price")}
                                />
                                </td>
                                <td>
                                <CurrencyInput intlConfig={{ locale: 'vi-VN', currency: 'VND' }}  onValueChange={(value)=>handleInfoTOPChange(value,i,j,"cost")}/>                                                                                    
                                </td>
                                <td>
                                    <input type="number" min={0} onChange={(e)=>handleInfoTOPChange(e.target.value,i,j,"weight")}/>
                                </td>
                                <td>
                                    <input className="form-control" type="number" min={0} onChange={(e)=>handleInfoTOPChange(e.target.value,i,j,"quantity")}/>
                                </td>
                            </tr>
                    ...
                    rows.push(
                        ...
                        <tr class= "info_classification" key={`${i}-${0}`}>
                            <td  >
                                <div style={{display:"flex", flexDirection:"column", alignItems:"center"}}>
                                    <div style={{textTransform:"capitalize"}}>{value1}</div>
                                    <img style={{maxWidth:100}} src={imageLabel1s[i]}></img>
                                    <input type="file" style={{ width: "100%" }} accept="image/*" onChange={(e)=>handleImagelabel1Change(e,i)}/>
                                </div>
                            </td>
                            ...
                            <td>
                            <CurrencyInput
                                intlConfig={{ locale: 'vi-VN', currency: 'VND' }} onValueChange={(value)=>handleInfoTOPChangeTitle2Null(value,i,"originalPrice")}
                            />
                            </td>
                            <td>
                            <CurrencyInput
                                intlConfig={{ locale: 'vi-VN', currency: 'VND' }} onValueChange={(value)=>handleInfoTOPChangeTitle2Null(value,i,"price")}
                            />
                            </td>
                            <td>
                            <CurrencyInput intlConfig={{ locale: 'vi-VN', currency: 'VND' }} onValueChange={(value)=>handleInfoTOPChangeTitle2Null(value,i,"cost")}/>                                                                                    
                            </td>
                            
                            <td>
                                <input className="form-control" type="number" min={0} onChange={(e)=>handleInfoTOPChangeTitle2Null(e.target.value,i,"weight")}/>
                            </td>
                            <td>
                                <input className="form-control" type="number" min={0} onChange={(e)=>handleInfoTOPChangeTitle2Null(e.target.value,i,"quantity")}/>
                            </td>
    ...
    const addProduct = async () => {
        ...
        try {
            ...
            console.log(product)
            const response = await axios.post('http://localhost:8083/api/product/add', product, {
    ...
    return (
        <div>
            {showSuccess && <SuccessComponent content={"Thêm mới sản phẩm thành công"} setContent={setContent}/>}
            <meta charSet="utf-8" />
                                ...
                                <div className="tile-body">
                                    ...
                                    <form className="row">
                                        ...
                                        <div className="form-group col-md-4 ">
                                            ...
                                            <select className="form-control supplier_input" id="exampleSelect1" onChange={(e)=>setSupplierInput(e.target.value)}>
                                        ...
                                        <div className="form-group-add-product col-md-12" style={{marginBottom:10}}>
                                            <div style={{display:"flex"}}>
                                                ...
                                                imageInput.map((value, index) => (
                                                    <div style={{width: `${100 / imageInput.length}%`, maxWidth:300, position:"relative", padding:"15px 30px", border: '2px solid black'}}>
                                                            ...
                                                            <div style={{width:"85%"}}>
                                                                <div style={{ backgroundColor: "#f6f6f6", marginBottom: "5px",position:"relative",borderRadius:5,padding:20 }}>
                                                                    ...
                                                                    <div className="form-group classification-1" style={{ display: "flex", alignItems: "center", width: "100%" }}>
                                                                        ...
                                                                        <input className="form-control col-md-4" onChange={(e) => { setTitle1(e.target.value) }} style={{ height: 35 }} type="text" />
                                                                    </div>
