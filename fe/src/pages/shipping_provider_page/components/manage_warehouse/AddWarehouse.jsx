...
const AddWarehouse = ({ addressDefault, setShowFormAdd,refreshWarehouseList,setAlert }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await warehouseService.save(updatedFormData);
    if(response.status == 200)
    {
      setAlert({message:"Lưu thông tin kho hàng thành công",type:"success"});
    }else{
      setAlert({message:"Vui lòng thử lại!!!",type:"fail"});
    }
    ...
    <div className="acc-container">
      ...
      <form className="acc-form" onSubmit={handleSubmit}>
        ...
        {addressDefault.id == null && (
          <>
            <div className="acc-form-group">
              <label htmlFor="username" style={{ width: "35%", margin: "auto" }}>
                Tên đăng nhập
              </label>
              <input
                type="text"
            ...
            <div className="acc-form-group">
              <label htmlFor="password" style={{ width: "35%", margin: "auto" }}>
                Mật khẩu
              </label>
              <input
                type="password"
        ...
        {addressDefault.id != null && (
          <div className="acc-form-group">
            <label htmlFor="changePassword" style={{ width: "35%", margin: "auto" }}>
              Mật khẩu mới
            </label>
            <input
              type="password"
        ...
        <div className="acc-form-group" style={{ display: "flex", justifyContent: "space-between" }}>
          ...
          <button type="button" onClick={() => setShowFormAdd(false)} className="acc-cancel-btn">
            Hủy
          </button>
        </div>
      </form>
