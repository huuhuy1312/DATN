...
public class UploadFile {
    ...
    public ResponseEntity<String> uploadFile(List<MultipartFile> files, String objectId, String objectName) throws IOException {
        ...
        for (MultipartFile multipartFile : files) {
            ...
            body.add("file", byteArrayResource); // Thêm mỗi tệp vào "file"
        }
